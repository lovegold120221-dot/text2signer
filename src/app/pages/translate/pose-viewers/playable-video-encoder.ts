...
export class PlayableVideoEncoder {
  ...
  static isSupported() {
    // Android WebView currently advertises WebCodecs but rejects the H.264
    // configuration asynchronously for every frame. Keep live signing active
    // and omit optional MP4 export on that native platform.
    return Capacitor.getPlatform() !== 'android' && 'VideoEncoder' in globalThis;
  }
